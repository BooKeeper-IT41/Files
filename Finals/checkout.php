...
if(isset($_POST['order_btn'])){
   ...
   $address = mysqli_real_escape_string($conn, 'flat no.  '. $_POST['city'].', '. $_POST['country']);
...
<head>
   ...
   <title>BooKeeper Checkout</title>
...
<section class="checkout">
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Country :</span>
            <input type="text" name="country" required placeholder="Philippines">
         </div>
      </div>
